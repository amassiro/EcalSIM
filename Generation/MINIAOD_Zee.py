...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(9600),
    output = cms.optional.untracked.allowed(cms.int32,cms.PSet)
)

# Input source
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/tmp/amassiro/ZEE_13TeV_TuneCUETP8M1_cfi_RECO.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step1 nevts:9600'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/amassiro/ZEE_13TeV_TuneCUETP8M1_cfi_MINIAOD.root'),
